...
ROOT_URLCONF = 'davidbabalola_config.urls'
...
WSGI_APPLICATION = 'davidbabalola_config.wsgi.application'
...
ACCOUNT_USER_DISPLAY = 'davidbabalola_config.utils.account_user_display'
